          ...
          <div class="card bg-dark text-white" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              ...
              <div class="mb-md-5 mt-md-4 pb-5">
                ...
                <h2 class="fw-bold mb-2 text-uppercase">Admin Control</h2>
                <p class="text-white-50 mb-5">Register Account</p>

                <form @submit.prevent="add_writer">
                  ...
                  <div class="form-outline form-white mb-4">
                    <input type="password" v-model="writer.password" class="form-control form-control-lg" required/>
...
<script>
  ...
  export default {
        ...
        methods: {
          ...
          add_writer(){
            this.axios
                .post('api/writer/add', this.writer)
                .then(response => (
